      ...
      <div className="flex-1 min-h-0 overflow-y-auto">
        <div className="p-4 space-y-4">
          ...
          {(() => {
            ...
            return (
              <Section title="10-Year Equity Outlook">
                <div className="py-2 space-y-3">
                  <p className="text-xs text-slate-400 leading-relaxed">
                    Based on estimated {(listing.appreciationRate * 100).toFixed(1)}%/yr historical appreciation for this community. Appreciation projections are uncertain — shown as scenarios only.
                  </p>
                  ...
                  <div className="border-t border-slate-200 pt-3 space-y-1.5">
                    ...
                    <p className="text-xs text-slate-400 leading-relaxed pt-1">
                      Simplified — does not account for rent growth, expense inflation, selling costs, or taxes. Income return and equity growth are separate and answer different questions.
                    </p>
                  </div>
                </div>
              </Section>
